#
#  Be sure to run `pod spec lint ManagedAppConfigLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "James Felton"
  # s.authors            = { "James Felton" => "james.felton@jamf.com" }
  # s.social_media_url   = "http://twitter.com/James Felton"
